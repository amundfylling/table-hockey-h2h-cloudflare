...
export const elements = {
  ...
  otToggleLabel: document.getElementById("ot-toggle-label"),
  tightToggle: document.getElementById("tight-toggle"),
  tightToggleLabel: document.getElementById("tight-toggle-label"),
  ...
  visualizationsSection: document.getElementById("visualizations-section"),
  matchesSection: document.getElementById("matches-section"),
  matchListHeading: document.getElementById("match-list-heading"),
  filterEmptyState: document.getElementById("filter-empty-state"),
  filterEmptyTitle: document.getElementById("filter-empty-title"),
  filterEmptyCopy: document.getElementById("filter-empty-copy"),
  clearFiltersBtn: document.getElementById("clear-filters-btn"),
  emptyStateTitle: document.getElementById("empty-state-title"),
  emptyStateCopy: document.getElementById("empty-state-copy"),
  retryBtn: document.getElementById("retry-btn"),
  mobileSortControl: document.getElementById("mobile-sort-control"),
